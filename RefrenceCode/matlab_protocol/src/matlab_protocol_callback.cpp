/**
 * \file matlab_protocol_callback.cpp
 *
...
void MatlabProtocol::callbackMatlabMsg(const std_msgs::String::ConstPtr &str_msg)
{
...
void MatlabProtocol::callbackCMsg(const mit_msgs::MocapPosition::ConstPtr &msg, const int32_t &index)
{
  C_[index] = *msg;
}


void MatlabProtocol::callbackSMsg(const mit_msgs::MocapPosition::ConstPtr &msg, const int32_t &index)
{
  S_[index] = *msg;
}

void MatlabProtocol::callbackTMsg(const std_msgs::Float64MultiArray::ConstPtr &msg)
{
  T_ = *msg;
}
